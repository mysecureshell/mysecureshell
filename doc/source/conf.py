...
# -*- coding: utf-8 -*-
#
# MySecureShell documentation build configuration file, created by
...
project = 'MySecureShell'
copyright = '2014, Pierre Mavro and Sebastien Tardif'
...
htmlhelp_basename = 'MySecureShelldoc'
...
texinfo_documents = [
  ('index', 'MySecureShell', 'MySecureShell Documentation',
   'Pierre Mavro & Sébastien Tardif', 'MySecureShell', 'One line description of project.',
   'Miscellaneous'),
]
