...
public final class SshFxpReadLink
{	
	public Response send(InputStream is, OutputStream os, Integer id, String linkName) throws IOException
	{
		PacketReceiver	receiver;
		PacketSender	sender = new PacketSender(Packet.SSH_FXP_READLINK);
